...
function MainContact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Unable to connect to server. Check your backend status!");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="max-w-350 mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 space-y-6" data-aos="fade-right">
            ...
            <p className="text-base text-slate-300 leading-relaxed max-w-md">
              Have questions about your order, custom drops, or collaborations?
              Drop us a message, or hit us up directly across our socials.
            </p>
            ...
            <div className="space-y-4 pt-4">
              <div className="flex items-center gap-4 text-slate-300">
                ...
                <div>
                  ...
                  <a
                    href="mailto:bundlebuddy@gmail.com"
                    className="hover:text-slate-100 transition-colors text-sm font-semibold"
                  >
          ...
          <div
            className="lg:col-span-7 w-full bg-neutral-800/40 border border-neutral-800 p-6 sm:p-8 rounded-2xl shadow-xl"
            data-aos="fade-left"
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="pt-2 flex justify-start">
                <button
                  type="submit"
                  disabled={loading}
                  className={`bg-[#434d5e] hover:bg-[#4f5b6e] text-white font-bold py-3 px-10 rounded-full text-sm shadow-md tracking-wider transition-colors duration-200 cursor-pointer uppercase ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
                >
